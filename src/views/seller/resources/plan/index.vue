<template>
  <div class="resource-container">
    ...
    <uploadExcel v-model="excelShow" :storeType="2" isDk :uploadApi="$api.saveDingKaiListByExcel" :historyApi="$api.queryDingKaiExcel" @on-upload-success="getList"></uploadExcel>
  </div>
</template>
