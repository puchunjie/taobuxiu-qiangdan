<template>
    <div class="tb-picker" v-clickoutside="ousideClick">
        ...
        <ajaxPanel ref="panel" :class="placement" :search="chech.name" :options="{searchTitle: tip,api: api}" :tip="tip" @on-picker="saveData" v-if="panelShow" :exclude="exclude"></ajaxPanel>
    </div>
</template>
